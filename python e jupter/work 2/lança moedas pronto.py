...
#o meu não gera resultado

#consegui arrumar, o de baixo ta funcionando 100%, o de cima n gera resultado
#e não aparece o resto das coisas 
...
def coinFlip():
    ...
    if(result == 1):
        tfield.insert(INSERT, " DEU...... ————> CARA!!!!")
        i.config(image = heads)
         
    else:
        tfield.insert(INSERT, " DEU...... ————> COROA!!!!")
        i.config(image = tails)
 
root = Tk()
root.title("Jogo de cara ou coroa")
...
root.geometry("500x500")
b1 = Button(root, text="Lançar moeda", font=("Arial", 10), command=coinFlip, bg='teal', fg='white', activebackground="lightblue", padx=10, pady=10)
b1.pack()
 
#Text Field for Result
tfield = Text(root, width=52, height=5)
tfield.pack()
tfield.insert(INSERT, "Aperte o botão para lançar a moeda e ver o resultado xD ")
